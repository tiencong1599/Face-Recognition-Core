...
class Camera:
    def __init__(self, url, camera_id, db_path):
        ...
        self.svm = pickle.load(open('D:/pythonProjects/Face-Recognition-Core/svm.pkl', 'rb'))
    ...
    def SerializeJson(self):
        ...
        folder = datetime.now().strftime('%d-%m-%Y')
        jsonfile = open(
            'D:\pythonProjects\Face-Recognition-Core\Core\Face-Recogition\logs\\' + str(folder) + '\\' + str(
                self.url) + str(time) + '.json',
            'w')
